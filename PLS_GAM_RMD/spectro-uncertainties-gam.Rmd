...
texture_df= read.csv(file.path(cnn_model_dir,"Mir","texture.csv"))
carbon_df= read.csv(file.path(cnn_model_dir,"Mir","carbon.csv"))
ph_df= read.csv(file.path(cnn_model_dir,"Mir","ph.csv"))
pret_df= read.csv(file.path(cnn_model_dir,"Mir","pret.csv"))

#merge the csv 
cnn_df <- merge(texture_df, carbon_df,  all = TRUE)
